...
=== 회원정보 조회(이메일)
.curl-request
include::{snippets}/get-member-by-email/curl-request.adoc[]

.http-request
include::{snippets}/get-member-by-email/http-request.adoc[]

.path-parameters
include::{snippets}/get-member-by-email/path-parameters.adoc[]
...
== AnswerLikeController (구현 예정)

== LogoutController
=== 로그아웃
.curl-request
include::{snippets}/post-logout/curl-request.adoc[]

.http-request
include::{snippets}/post-logout/http-request.adoc[]

.request-fields
include::{snippets}/post-logout/request-fields.adoc[]
